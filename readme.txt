...
prepare_data_jpg.py:
    ...
    補充:
    將第8行input_file路徑改成自己的，如果是linux os的話20行split內容改成'/'
...
prepare_data_txt.py:
    ...
    補充:
    將第8,11,14行input_file路徑改成自己的，如果是linux os的話39,53,56行split內容改成'/'
...
predict.py:
    ...
    補充:
    第7行raw_niigz_path改成自己的input data path
    若需查看一張dicom的預測結果可以使用下方指令
